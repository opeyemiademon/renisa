...
export const paymentReceiptTemplate = (name: string, amount: number, type: string, ref: string): string => `
<!DOCTYPE html>
<html>
...
export const idCardStatusTemplate = (name: string, status: string, reason?: string): string => `
<!DOCTYPE html>
<html>
...
export const donationInvoiceTemplate = (donorName: string, invoiceNumber: string, amount: number, paymentLink: string): string => `
<!DOCTYPE html>
<html>
